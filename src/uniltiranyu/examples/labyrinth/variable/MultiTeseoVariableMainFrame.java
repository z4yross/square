...
public class MultiTeseoVariableMainFrame extends JFrame {
	...
	//  MultiChart multiChart1 = new MultiChart();
	  ...
	  public MultiTeseoVariableMainFrame( Array<Agent> _agent, SimpleLanguage _language, double prob ) {
	    this( "Labyrinth", _agent, _language, prob );
	  }

	  public MultiTeseoVariableMainFrame( String _title, Array<Agent> _agent, SimpleLanguage _language, double prob ) {
