...
public class MultiTeseoEaterMainFrame extends JFrame{
  ...
  //  MultiChart multiChart1 = new MultiChart();
    ...
    public MultiTeseoEaterMainFrame( Array<Agent> _agent, SimpleLanguage _language ) {
      this( "Labyrinth", _agent, _language );
    }

    public MultiTeseoEaterMainFrame( String _title, Array<Agent> _agent, SimpleLanguage _language ) {
      title = _title;
